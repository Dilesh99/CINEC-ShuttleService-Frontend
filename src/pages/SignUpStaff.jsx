      ...
      try {
        ...
        if (Object.keys(data).length > 0) {  // Check if the response is not empty
          ...
          const updateResponse = await fetch(`${backEndURL}/updateStaff`, {
            ...
            body: JSON.stringify({ staffID: staffID, shuttleID: "undefined", username, email, phone_number: Number(phone_number), password, paymentStatus: false, scannedStatus: false})
          });
